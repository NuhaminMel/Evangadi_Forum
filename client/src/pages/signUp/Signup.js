...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:9500/api/users", form);
  ...
  return (
    <div className="bg-gray-100  md:inline-flex lg:inline-flex items-center justify-center w-full p-6 landing">
      <div className="bg-white rounded-md md:shadow-2xl  p-12 ">
        ...
        <Link to="/login" className="text-blue-500 hover:text-orange-500">
      ...
      <div className=" p-6  w-96 md:ms-16 md:w-[400px]">
        ...
        <p className="text-[30px] font-semibold text-indigo-800">
          Evangadi Networks
        </p>
